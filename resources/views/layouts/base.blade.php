...
<ul class="visible-md visible-lg text-left">
    ...
    <li><a href="mailto:contact@liveacademy.in"><i class="fa fa-envelope"></i>
            contact@liveacademy.in</a></li>
</ul>
...
<li> <a href="{{route('home.service-category')}}">Serive Categories</a>
...
@auth
 @if (Auth::user()->utype ===('ADM'))
    ...
    <ul class="drop-down one-column hover-fade">
        ...
        <li><a href="{{route('admin.add-service-category')}}"> Add Category</a></li>
            ...
            <ul class="contact_footer">
                ...
                <li>
                    <i class="fa fa-envelope"></i> <a
                        href="mailto:contact@liveacademy.in">contact@liveacademy.in</a>
                </li>
                <li>
...
<div class="footer-down">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <p class="text-xs-center crtext">&copy; 2021 liveacademy. All Rights Reserved.</p>
            </div>
        </div>
    </div>                
</div>            
